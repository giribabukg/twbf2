    ...
    <div class="swiper-container hero-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide hero-content-wrap">
                <img src="{{ asset('vendor/thecharity/images/hero.jpg') }}" alt="">
            ...
            <div class="row">
                <div class="col-12 col-lg-6 order-2 order-lg-1">
                    <div class="welcome-content">
                        <header class="entry-header">
                            <h2 class="entry-title">Wellcome to our TWBF</h2>
                        </header><!-- .entry-header -->
                ...
                <div class="col-12 col-lg-6">
                    <div class="featured-cause">
                        ...
                        <div class="cause-wrap d-flex flex-wrap justify-content-between">
                            <figure class="m-0">
                                <img src="{{ asset('vendor/thecharity/images/featured-causes.jpg') }}" alt="">
                            </figure>
                ...
                <div class="col-12 col-lg-6">
                    <div class="milestones d-flex flex-wrap justify-content-between">
                        <div class="col-12 col-sm-4 mt-5 mt-lg-0">
                            <div class="counter-box">
                                <div class="d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('vendor/thecharity/images/teamwork.png') }}" alt="">
                                </div>
                        ...
                        <div class="col-12 col-sm-4 mt-5 mt-lg-0">
                            <div class="counter-box">
                                <div class="d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('vendor/thecharity/images/donation.png') }}" alt="">
                                </div>
                        ...
                        <div class="col-12 col-sm-4 mt-5 mt-lg-0">
                            <div class="counter-box">
                                <div class="d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('vendor/thecharity/images/dove.png') }}" alt="">
                                </div>
