            ...
            <div class="row">
                <div class="col-12 col-lg-8">
                    <div class="news-content">
                        <a href="#"><img src="{{ asset('vendor/thecharity/images/1.jpg') }}" alt=""></a>
                        ...
                        <header class="entry-header d-flex flex-wrap justify-content-between align-items-center">
                            ...
                            <div class="donate-icon">
                                <a href="#"><img src="{{ asset('vendor/thecharity/images/donate-icon.png') }}" alt=""></a>
                            </div>
                        </header>
                    ...
                    <div class="news-content">
                        <a href="#"><img src="{{ asset('vendor/thecharity/images/2.jpg') }}" alt=""></a>
                    ...
                    <div class="news-content">
                        <a href="#"><img src="{{ asset('vendor/thecharity/images/3.jpg') }}" alt=""></a>
                ...
                <div class="col-12 col-lg-4">
                    <div class="sidebar">
                        ...
                        <div class="popular-posts">
                            ...
                            <ul class="p-0">
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="{{ asset('vendor/thecharity/images/p-1.jpg') }}" alt=""></a></figure>
                                ...
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="{{ asset('vendor/thecharity/images/p-2.jpg') }}" alt=""></a></figure>
                                ...
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="{{ asset('vendor/thecharity/images/p-3.jpg') }}" alt=""></a></figure>
                        ...
                        <div class="upcoming-events">
                            ...
                            <ul class="p-0">
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="{{ asset('vendor/thecharity/images/u-1.jpg') }}" alt=""></a></figure>
                                ...
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="{{ asset('vendor/thecharity/images/u-2.jpg') }}" alt=""></a></figure>
                                ...
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="#"><img src="{{ asset('vendor/thecharity/images/u-3.jpg') }}" alt=""></a></figure>
                        ...
                        <div class="featured-cause">
                            ...
                            <div class="cause-wrap">
                                <figure class="m-0 position-relative">
                                    <a href="#"><img src="{{ asset('vendor/thecharity/images/cause-3.jpg') }}" alt=""></a>
                                </figure>
